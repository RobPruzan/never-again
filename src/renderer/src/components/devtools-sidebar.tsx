...
export function DevToolsSidebar() {
  ...
  return (
    <div className="w-full h-full bg-[#0A0A0A] flex flex-col items-center justify-between">
      <div
      ...
      {/* AI Service Logos at the bottom */}
      <div className="flex flex-col items-center pb-2 space-y-1">
        <button
          title="Gemini"
          className="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-white transition-colors rounded-md hover:bg-[#1A1A1A]"
        >
          <Gemini />
        </button>
